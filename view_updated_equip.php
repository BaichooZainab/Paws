...
<div class="row" data-aos="zoom-in" data-aos-delay="100">
        ...
        <h4 class="mt-4 text-center"><strong>Update Details of your Equipments</strong></h4>
       ...
       echo   '<div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
              ...
              echo '<p class="card-text">' . htmlentities($row['equip_desc']) . '</p>';
                ...
                echo '<a href="update_equip.php?eid=' . $row['equip_id'] . '" class="btn btn-primary">Update Equipment</a>
