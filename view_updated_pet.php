...
<div class="row" data-aos="zoom-in" data-aos-delay="100">
        ...
        <h4 class="mt-4 text-center"><strong>Update Details of your Pet</strong></h4>

        <?php
//add sql to read from tblevent
$stmt = $pdo->prepare('SELECT * FROM tblpet WHERE d_id = :did');
...
htmlentities($row['arrival_date']) . '</p>';
                ...
                echo '<a href="update_petdetails.php?pid=' . $row['pet_id'] . '" class="btn btn-primary">Update Pet</a>
