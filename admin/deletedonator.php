...
echo '<form id="frmdel" action="delete.php?did=' . $rows["d_id"] .'" method="post">

<td>
<button type="submit" name="btndel" class="col-12 btn btn-outline-danger btn-lg mx-auto"> Delete Donators </button>
</td>
</tr>
</form>';
}
