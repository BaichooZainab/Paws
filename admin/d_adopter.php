...
echo '<form id="frmdel" action="delete.php?aid=' . $rows["a_id"] .'" method="post">

<td>
<button type="submit" name="btndel" class="col-12 btn btn-outline-danger btn-lg mx-auto"> Delete Adopters </button>
</td>
</tr>
</form>';
}
