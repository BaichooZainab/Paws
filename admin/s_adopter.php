...
header('Location: s_adopter.php');
return;
}

if (isset($_POST['txtauname'])) {
...
<form id="frmsearchad" method="post" enctype="multipart/form-data">

<h2 class="mt-3">Search Adopter By Username</h2>

<div class="mb-3">
<label for="txtauname" class="form-label">Username</label>
<input type="text" class="form-control" name="txtauname" id="txtauname" />
...
<h3 class="mt-3">Adopter Listing</h3>
...
$stmt = $pdo->prepare("select * from tbladopter where a_username = :auname ");
//retrieve the textbox value
$stmt->execute(array(":auname" => $_POST["txtauname"]));
}
