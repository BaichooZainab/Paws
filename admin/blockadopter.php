...
<title>Block & unblock Adopters</title>
<!--Bootstrap -->
...
echo '<form id="frmdel" action="block.php?aid=' . $rows["a_id"] .'" method="post">

<td>
<button type="submit" name="btndel" class="col-12 btn btn-outline-danger btn-lg mx-auto"> Block Adopters </button>
</td>

</form>';

echo '<form id="frmdel" action="unblock.php?aid=' . $rows["a_id"] .'" method="post">

<td>
<button type="submit" name="btndel" class="col-12 btn btn-outline-danger btn-lg mx-auto"> Unblock Adopters </button>
</td>
</tr>
</form>';
}
